            ...
            <form action="/dashboard/store" method="POST">
                ...
                <div class="linha-1">
                    <div class="form-group input-dominio input-dominio">
                        ...
                        <input type="text" class="form-control" id="dominio" name="dominio" placeholder="Insira o Domínio" required>
                    </div>
                ...
                <div class="linha-4">
                    <div class="form-group input-expiracao">
                        ...
                        <input type="date" class="form-control" id="expiracao" name="expiracao" placeholder="Insira a Data" required>
                    </div>
